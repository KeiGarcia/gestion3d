  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-700/60">
        ...
        <div>
          <span className="font-bold text-lg leading-tight">3DGestión</span>
          <p className="text-xs text-slate-500 leading-tight">Panel de gestión</p>
        </div>
        {/* Close button (mobile) */}
        <button onClick={onClose} className="ml-auto md:hidden p-1 rounded hover:bg-slate-800" aria-label="Cerrar menú">
      ...
      <div className="px-3 py-4 border-t border-slate-700/60 space-y-1">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-white"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
